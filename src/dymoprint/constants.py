...
DEPRECATION_MESSAGE_ANSI = (
    ...
    f"than v2.5.{ANSI_GREEN}\n"
    f"\n"
    f"  pipx uninstall dymoprint\n"
    f"  pipx install labelle\n"
    f"{ANSI_RED}\n"
    f"For more info about Labelle, visit <https://github.com/labelle-org/labelle>.\n"
    f"For upgrade advice, see "
    f"<https://github.com/computerlyrik/dymoprint/issues/114#issuecomment-2106318909>."
    f"{ANSI_RESET}\n\n"
)
DEPRECATION_MESSAGE_POPUP = (
    ...
    "</pre>"
    "For more info, visit <a href='https://github.com/labelle-org/labelle'>"
    "Labelle</a>."
    "<br>"
    "For more details on how to upgrade, please read <a href="
    "'https://github.com/computerlyrik/dymoprint/issues/114#issuecomment-2106318909'>"
    "this comment</a>."
)
